...
export const PLACEMENT_GROUPS: PlacementGroup[] = [
  // ── FACEBOOK ──────────────────────────────────────────────────────────────
  {
    ...
    placements: [
      ...
      {
        id: "fb_reels", label: "Reels FB ⚠️", icon: "🎬",
        format: ["video"],
        orientation: ["vertical"],
        tooltip: "❌ Facebook Reels não é suportado via API padrão (erro 1815433). Use Instagram Reels.",
        idealRatios: ["9:16"],
        blockedRatios: ["16:9","1:1","4:5","1.91:1"],
        minResolution: "500×889",
        maxDuration: 30,
        performanceTip: "⚠️ Não disponível via API — use ig_reels",
        apiUnsupported: true,
        disabled: true,
      },
      {
