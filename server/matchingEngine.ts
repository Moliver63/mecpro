...
Seja direto, técnico e específico para o nicho. Máximo 120 palavras.`;
      ...
      const aiReasoning = await gemini(aiPrompt, { temperature: 0.3, cacheAs: "match_score", cacheMeta: { projectId: input?.projectId, objective: input?.objective, platform: input?.platform } });
