...
// precisam existir como palavra completa na lista (ver nicheKeys de cada
// segmento). Reaproveitada nos dois sistemas de segmento desta base
// (aqui e em server/ai.ts's SEGMENT_COPY_RULES) — mesma função, uma fonte.
